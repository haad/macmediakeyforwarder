...
//
//  Created by haad on 10/02/2025.
//  Copyright © 2025 Adam Hamsik. All rights reserved.
//
...
@class EndelApplication, EndelTrack;

enum EndelEPlS {
    EndelEPlSStopped = 'kPSS',
    EndelEPlSPlaying = 'kPSP',
    EndelEPlSPaused = 'kPSp'
};
typedef enum EndelEPlS EndelEPlS;
...
// The Endel application.
@interface EndelApplication : SBApplication

@property (copy, readonly) EndelTrack *currentTrack;  // The current playing track.
@property NSInteger soundVolume;  // The sound output volume (0 = minimum, 100 = maximum)
@property (readonly) EndelEPlS playerState;  // Is Endel stopped, paused, or playing?
...
@interface EndelApplication (StandardSuite)
